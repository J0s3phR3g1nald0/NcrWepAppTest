...
def DateCompare(years,months,days,receiver,ncr_no,update_date,DEADLINE,is_incharge):
        ...
        try:
            if message not in ('', None):
                ...
                if is_incharge:
                    ...
                    See the details via this link: <br/>""" + PROJ_URL + """ncr_create_view_upd_via_mail/"""+ncr_no+"""/"""+ receiver +"""      """"""<br/><br/>
                    ...
                    You might have missed in the correspondence of the said NCR. \n\n
                    Kindly continue the NCR on or before its deadline on """+ str(DEADLINE) +"""
                    See the details via this link: <br/>""" + PROJ_URL + """ncr_verify_view_via_mail/"""+ncr_no+"""/"""+ receiver +"""      """"""<br/><br/>
                    This message is automatically generated by the NCR WebApp System."""
...
def update_Date():
    ...
    #mycursor.execute("SELECT * FROM `ncr_detail_mstr` WHERE status not in ('2','5')  ")

    mycursor.execute("SELECT * FROM `ncr_detail_mstr` WHERE ncr_no = 'NCR-2024-05-10-BA-01-0140'  ")#Test for only one ncr
    ...
    for x in myresult:
        ...
        #SELECT DENY REASON THAT Hasn't been accepted
        ...
        if days >= 2 or months >= 1 or years >= 1 :
            print("days "+str(days))
            print("months "+str(months))
            print("years "+str(years))
            
            
            #If there is active deny reason sendmail to in charge
            if denyReason == True:
                ...
                if status == '7': #Email will sent to SH if NCR is Cancel Request
                    receiver = nc_conformed_by
                elif se_check_date_by_qa not in ('', None):
                    receiver = ic_incharge
                    is_incharge = True
                    print("-1")
            ...
            print(ncr_no)
            DateCompare(years,months,days,receiver,ncr_no,update_date,DEADLINE,is_incharge)
