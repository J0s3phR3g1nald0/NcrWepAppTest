    ...
    if "logged_user_chapa_no" in request.session:
        ...
        try:
            ...
            form = NCRCreateForm(initial={                
                    ...
                    #Start Add CJ.AVILA
                    'consumed_mh1' : n.consumed_mh1,
                    'consumed_mh2' : n.consumed_mh2,
                    'consumed_mh3' : n.consumed_mh3,
                    'consumed_mh4' : n.consumed_mh4,
                    #End Add CJ.AVILA
...
def sendmail_create(mailType, n, userId):
    ...
    if mailType == 'A':
        ...
        #modified by ROS 2022/06/08
        #e =  Employee.objects.get(\n\n    Good day.chapano=n.ic_approve_by)
        e =  Employee.objects.get(chapano=n.rca_approve_by) 
        #user_id = e.chapano
        send_to = e.email
...
def sendmail_verify_accept(mailType, n):    
    ...
    if mailType == '1':
        ...
        if n.ca_checked_by_sh != n.rca_approve_by:
            ...
            content = "Sir/Madam,\n\n    Good day.\n\n    The content of root cause analysis has been accepted by Mr./Ms. " +  e3.lastname + ", " + e3.firstname + " " + e3.middlename +"  and corrective action had been accepted by " +  e1.lastname + ", " + e1.firstname + " " + e1.middlename + ".\n\n    Kindly confirm content for your approval by clicking on the link below.\n\n    " + PROJ_URL + "ncr_verify_view_via_mail/" + n.ncr_no + "/" + user_id + "\n\n    Thank you for using the NCR Management System. \n\n    This is a system-generated e-mail. Please do not reply."
        else:
            content = "Sir/Madam,\n\n    Good day.\n\n    The content of root cause analysis and corrective has accepted by Mr./Ms. " +  e1.lastname + ", " + e1.firstname + " " + e1.middlename + ".\n\n    Kindly confirm content for your approval by clicking on the link below.\n\n    " + PROJ_URL + "ncr_verify_view_via_mail/" + n.ncr_no + "/" + user_id + "\n\n    Thank you for using the NCR Management System. \n\n    This is a system-generated e-mail. Please do not reply."
...
def ncr_create(request):
    ...
    nc_discovered_by_email = request.POST.get('nc_discovered_by_email', '')
...
def ncr_create_insert(request, form, login_user_chapa_no):
    ...
    n.deadline = deadline
    n.status = '1'
    n.nc_discovered_by_email = nc_discovered_by_email
    if ic_incharge not in ('', None):
...
def ncr_create_update(request, form, ncr_no, login_user_chapa_no, edit_cause):
    ...
    consumed_mh4 = form.cleaned_data['consumed_mh4']
    #END Add CJ.AVILA
   ...
   #Start adding for additional request Edric 2024/03/06
    ...
    try:
        ...
        #START Add CJ.AVILA
        n_consumed_mh2 = ''
        if (n.consumed_mh2 not in ('', None)):
            n_consumed_mh2 = n.consumed_mh2 
        #END Add CJ.AVILA
        ...
        #START Add CJ.AVILA
        n_consumed_mh3 = ''
        if (n.consumed_mh3 not in ('', None)):
            n_consumed_mh3 = n.consumed_mh3
        #END Add CJ.AVILA
        ...
        #START Add CJ.AVILA
        n_consumed_mh4 = ''
        if (n.consumed_mh4 not in ('', None)):
            n_consumed_mh4 = n.consumed_mh4
        #END Add CJ.AVILA
        #     
        #E. Result of action 
        n_ra_description = ''    
        ...
        #END: Add reginaldo-jsp 2025/02/07
            ...
            #C. Root Cause Analysis(5 Whys, Fishbone, etc)
            if n_rca_description != rca_description or n_ca_necessary != ca_necessary or n_rca_approve_by != rca_approve_by_chapano or convertNoneToNull(n_consumed_mh3) != convertNoneToNull(consumed_mh3):               
                has_change_C = True  
            ...
            #D. Corrective Action to the cause
            if n_ca_description != ca_description or n_ca_target_date != ca_target_date_str or n_ca_approved_by_mgr != ca_approved_by_mgr_chapano or n_ca_checked_by_sh != ca_checked_by_sh_chapano or convertNoneToNull(n_consumed_mh4) != convertNoneToNull(consumed_mh4):
                has_change_D = True  
    
                n.ca_description = ca_description 
                #START Add CJ.AVILA
                n.consumed_mh4 = consumed_mh4
                #END Add CJ.AVILA
